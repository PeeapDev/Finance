...
// Test route for schools (temporary)
Route::get('test/schools', function() {
    return response()->json([
        'message' => 'Schools API is working',
        'schools' => \App\Models\School::all()
    ]);
});

// Education routes (temporarily outside auth for testing)
Route::prefix('education')->group(function () {
    // Schools management
    Route::get('/schools/search', [\App\Http\Controllers\API\SchoolController::class, 'search']);
    Route::get('/schools/{school}/invoices', [\App\Http\Controllers\API\SchoolController::class, 'getInvoices']);
    Route::post('/schools/{school}/invoices', [\App\Http\Controllers\API\SchoolController::class, 'createInvoice']);
    Route::apiResource('schools', \App\Http\Controllers\API\SchoolController::class);
    
    // ID Cards management
    Route::get('/idcards/search', [\App\Http\Controllers\API\IdCardController::class, 'search']);
    Route::get('/idcards/{idcard}/school', [\App\Http\Controllers\API\IdCardController::class, 'getSchool']);
    Route::post('/idcards/{idcard}/invoice', [\App\Http\Controllers\API\IdCardController::class, 'createInvoice']);
    Route::apiResource('idcards', \App\Http\Controllers\API\IdCardController::class);
});
Route::group(['middleware' => 'auth:api,web'], function () {
    ...
    // Email routes for invoices and receipts
    Route::post('/invoices/{invoice}/send', [\App\Http\Controllers\API\SchoolController::class, 'sendInvoice']);
    Route::post('/invoices/{invoice}/receipt', [\App\Http\Controllers\API\SchoolController::class, 'sendReceipt']);
