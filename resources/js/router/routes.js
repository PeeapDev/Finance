...
export default [
  ...
  // Education Routes
  {
    ...
    component: page("education/schools.vue"),
    meta: { permissions: ["education-schools"] }
  },
  {
    path: "/education/schools/:id",
    name: "education.school-detail",
    component: page("education/school-detail.vue"),
    meta: { permissions: ["education-schools"] }
  },
  {
    path: "/education/idcards",
    name: "education.idcards",
    component: page("education/idcards.vue"),
    meta: { permissions: ["education-idcards"] }
  },
  {
    path: "/education/idcards/:id",
    name: "education.idcard-detail",
    component: page("education/idcard-detail.vue"),
    meta: { permissions: ["education-idcards"] }
  },
  {
    path: "/education/electronic",
    name: "education.electronic",
    component: page("education/electronic.vue"),
    meta: { permissions: ["education-electronic"] }
  }
];
