              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-6">
                  <div class="small-box bg-warning">
                    <div class="inner">
                      <h3>
                        {{ dashboardSummery.totalSchools || 0 }}
                      </h3>
                      <p>{{ $t("Number of Schools") }}</p>
                    </div>
                    <div class="icon">
                      <i class="fas fa-graduation-cap"></i>
                    </div>
                    <router-link :to="{ name: 'education.schools' }" class="small-box-footer">
                      {{ $t("More info") }}
                      <i class="fas fa-arrow-circle-right"></i>
                    </router-link>
                  </div>
                ...
                <div class="col-lg-3 col-6">
                  <div class="small-box bg-purple">
                    <div class="inner">
                      <h3>
                        {{ (dashboardSummery.totalIdCardSales || 0) | withCurrency }}
                      </h3>
                      <p>{{ $t("Total ID Card Sales") }}</p>
                    </div>
                    <div class="icon">
                      <i class="fas fa-id-card"></i>
                    </div>
                    <router-link :to="{ name: 'education.idcards' }" class="small-box-footer">
                      {{ $t("More info") }}
                      <i class="fas fa-arrow-circle-right"></i>
                    </router-link>
                  </div>
