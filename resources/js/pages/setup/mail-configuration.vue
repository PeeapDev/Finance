            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="mail_mailer">{{ $t("MAIL MAILER") }}
                    <span class="required">*</span></label>
                  <input id="mail_mailer" v-model="form.mail_mailer" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_mailer') }" name="mail_mailer" :placeholder="$t('MAIL MAILER')
                      " required />
                  <has-error :form="form" field="mail_mailer" />
                </div>
                <div class="form-group col-md-12">
                  <label for="mail_host">{{ $t("MAIL HOST") }}
                    <span class="required">*</span></label>
                  <input id="mail_host" v-model="form.mail_host" type="text" class="form-control"
                    ...
                    :placeholder="$t('MAIL HOST')" required />
                  <has-error :form="form" field="mail_host" />
                </div>
                <div class="form-group col-md-12">
                  <label for="mail_port">{{ $t("MAIL PORT") }}
                    <span class="required">*</span></label>
                  <input id="mail_port" v-model="form.mail_port" type="text" class="form-control"
                    ...
                    :placeholder="$t('MAIL PORT')" required />
                  <has-error :form="form" field="mail_port" />
                </div>
                <div class="form-group col-md-12">
                  <label for="mail_username">{{ $t("MAIL USERNAME") }}
                    <span class="required">*</span></label>
                  <input id="mail_username" v-model="form.mail_username" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_username') }" name="mail_username" :placeholder="$t('MAIL USERNAME')
                      " required />
                  <has-error :form="form" field="mail_username" />
                </div>
                <div class="form-group col-md-12">
                  <label for="mail_password">{{ $t("MAIL PASSWORD") }}
                    <span class="required">*</span></label>
                  <input id="mail_password" v-model="form.mail_password" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_password') }" name="mail_password" :placeholder="$t('MAIL PASSWORD')
                      " required />
                  <has-error :form="form" field="mail_password" />
                </div>
                <div class="form-group col-md-12">
                  <label for="mail_encryption">{{ $t("MAIL ENCRYPTION") }}
                    <span class="required">*</span></label>
                  ...
                  }" name="mail_encryption" :placeholder="$t('MAIL ENCRYPTION')"
                    required />
                ...
                <div class="form-group col-md-12">
                  ...
                  }" name="mail_from_address" :placeholder="$t('MAIL FROM ADDRESS')"
                    required />
