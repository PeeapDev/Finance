                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr
                        ...
                        v-if="allData.purchase.accountReceivable"
                      >
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("Supplier Purchase Payment Details") };
  },
  data: () => ({
