    ...
    <div class="sidebar custom-sidebar">
      ...
      <nav class="py-3 pb-5" :class="{ 'd-none': menuSearchQuery }">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-header text-bold">{{ $t("EDUCATION") }}</li>
          <li class="nav-item has-treeview" :class="menuOpen('schools') ||
            menuOpen('idcards')
            ? 'menu-is-opening menu-open'
            : ''
            ">
            ...
            <ul class="nav nav-treeview" :style="menuOpen('schools') ||
              menuOpen('idcards')
              ? 'display: block'
              : 'display: none'
              ">
              <li class="nav-item">
                <router-link :to="{ name: 'education.schools' }" class="nav-link">
                  <i class="fas fa-school nav-icon" />
                  <p>{{ $t("Schools Management") }}</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'education.idcards' }" class="nav-link">
