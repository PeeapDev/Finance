...
class DemoDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $this->call(DemoMigrationsTableSeeder::class); // 'migrations' table automatically insert data when any migration file executes. It does not requires to add data manually.
